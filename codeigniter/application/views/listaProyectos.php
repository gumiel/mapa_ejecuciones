          ...
          <div class="list-group">
            ...
            ?>
              <a href="#" class="list-group-item disabled">
                <div class="row">
                  <div class="col-md-2">
                      <img class="img-thumbnail" alt="100x100" src="img_proyectos/<?php echo $value['img_miniatura'] ?>" data-holder-rendered="true" style="width: 100px; height: 100px;">  
                  </div>
                  <div class="col-md-10">
